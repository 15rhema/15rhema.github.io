...
By accessing or using the Platrs mobile application ("App"), you agree to be bound by these Terms of Service ("Terms"). If you disagree with any part of these terms, you may not access the App.
...
- You must register using valid Google Sign-In credentials
...
- Honest and unbiased
- Free from hate speech or harassment
- Not incentivized by payment or rewards

## 6. Intellectual Property
- The App and its content are owned by Platrs
...
- We don't guarantee continuous availability
- Restaurant information may not be accurate
- User reviews reflect personal opinions
...
## 13. Governing Law
These Terms are governed by the laws of United States of America, without regard to conflicts of law principles.

## 14. Changes to Terms
We reserve the right to update these Terms. We will notify users of significant changes via the App or email.
...
## 17. Entire Agreement
These Terms constitute the entire agreement between you and Platrs regarding use of the App.
